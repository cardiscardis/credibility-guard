    ...
    <>
      <div className="flex flex-col items-center text-center font-mono">
        ...
        <p className="mb-8 text-xs text-gray-600">
          Credibility Guard, our decentralized app on Aleph Zero, tackles the fake news dilemma by
          engaging users in a dynamic truth-seeking process. Users upload suspicious news,
          initiating a prediction market where bettors stake on its authenticity. Voters,
          economically incentivized to uphold truth, stake platform tokens. The news uploader pays
          fees, profiting as more users engage. Bettors enjoy market-adjusted rates and payouts
          based on collective predictions, creating a system where accuracy is financially rewarded.
          Credibility Guard transforms users into guardians of credibility, fostering a transparent
          information landscape and incentivizing active participation in the fight against
          misinformation. .
        </p>
