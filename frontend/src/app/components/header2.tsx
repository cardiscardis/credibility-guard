...
export default function Header2() {
  ...
  return (
    <header className="clearNav z-50 w-full">
      <div className="mx-auto flex flex-col flex-wrap md:flex-row">
        <div className="flex flex-row items-center justify-between p-1">
          <button
            className="ml-auto cursor-pointer content-end px-3 py-1 pb-1 leading-none text-white outline-none focus:outline-none md:hidden"
            type="button"
            aria-label="button"
        ...
        <div className={'flex-grow items-center md:flex' + (navbarOpen ? ' flex' : ' hidden')}>
          <div className="font-4 text-1xl flex flex-wrap items-center justify-items-start pl-1 pt-1 md:ml-auto md:mr-auto md:justify-center md:pl-14 md:text-base">
            <a
              href="/"
              className="tr04 mr-32 cursor-pointer pr-2 font-semibold text-gray-300 hover:text-white"
            >
              Home
            </a>
            ...
            <a
              href="/aboutus"
              className="tr04 ml-0 mr-12 cursor-pointer font-semibold text-gray-300 hover:text-white md:mr-32"
            >
              About Us
            </a>
            <a
              href="/add-news"
              className="tr04 mr-11 cursor-pointer font-semibold text-gray-300 hover:text-white"
            >
              Get Started
            </a>
          </div>
