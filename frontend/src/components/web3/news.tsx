  ...
  return (
    <>
      <div className="flex max-w-[22rem] grow flex-col gap-4">
        <h2 className="text-center font-mono text-gray-400">News</h2>
        ...
        <Form {...form}>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              >
                <FormItem>
                  <FormLabel className="text-base">Post News</FormLabel>
                  <FormControl>
          ...
          <Card>
            <CardContent className="pt-6">
              <FormItem>
                <FormLabel className="text-base">Fetched News</FormLabel>
                <FormControl>
                  <Input
        ...
        <Card>
          <CardHeader>
            <CardTitle>Vote News</CardTitle>
          </CardHeader>
          <CardContent className="pt-6">
            <CardDescription className="flex flex-row gap-4">
              <Button className="bg-success font-bold">True</Button>
              <Button className="bg-[#bd2d17] font-bold">False</Button>
            </CardDescription>
          </CardContent>
        </Card>
        {/* Contract Address */}
